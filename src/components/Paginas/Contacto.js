    ...
    <div class="row">
      ...
      <div class="atencion col-lg-4">
        ...
        <div class="info">
          <div class="email">
            <h4>Email:</h4>
            <a href="mailto:clientes@galantr.com.ar" target="_blank"><i class="bi bi-envelope"></i>clientes@galantry.com.ar</a>
          </div>

          <div class="phone">
            <h4>Whatsapp o Celular:</h4>
            <a href="https://api.whatsapp.com/send?phone=05491154090544" target="_blank"><i class="bi bi-whatsapp"></i>11 5409-0544</a>
          </div>
